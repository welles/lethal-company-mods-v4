...
<details>
<summary> 3.9.4 - 2024-07-12 </summary>

- Hotfixed boot error crash.
...
<details>
<summary> 3.8.2 - 2024-06-30 </summary>
...
- Implemented an alternative "Item Progression" mode where you can acquire upgrades based on the items you sell alongside using credits to purchase them (default off in config).
