## Version 0.2.9. - THE SCRAPHEAP PATCH.

* Fixed the mod for V81!
**-** **Biodiversity is now under the new leadership of MrSaltedBeef and JacuJ. If any bugs or errors catch your eye, please contact *them* in the Lethal Company Modding discord!**

#### Ogopogo:

* Added a collision check for Ogopogo, meaning his snout can no longer go through walls and grab you.
* Added SFX for Ogopogo hitting an object on his way to grab you.
* Fixed Ogopogo dealing fall damage when he grabs you and pulls you underwater (Thank you, Ccode!)

#### Misc:

* Added the Scrap Radar
- Collect one by searching outdoors on Experimentation, March or Artifice!
- Use it while outdoors to search for a multitude of unique and valuable scrap items!
* To compensate the Scrap Radar, added 7 new scrap items obtainable only through this feature (one of which has a variant).
